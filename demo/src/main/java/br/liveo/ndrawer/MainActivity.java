...
public class MainActivity extends NavigationLiveo implements NavigationLiveoListener {
    ...
    public void onUserInformation() {
       ...
       // this.mUserBackground.setBackgroundColor();
    }
    ...
    public void onInt(Bundle savedInstanceState) {
       ...
       // this.setFooterInformationDrawer(R.string.settings, R.drawable.ic_settings_black_24dp);
        this.setFooterInformationDrawer(R.string.settings, R.drawable.ic_settings_black_24dp,android.R.color.white,android.R.color.white);
//added
        this.setColorSelectedItemNavigation(android.R.color.holo_red_dark);

       // setFooterInformationDrawer(int title, int icon, int colorName, int colorIcon)
